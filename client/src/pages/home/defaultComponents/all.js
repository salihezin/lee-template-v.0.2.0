              ...
              <div className="col-md-6 col-lg-4">
                ...
                <article className="box-chloe box-chloe_secondary">
                  ...
                  <div className="box-chloe__main">
                    ...
                    <p>
                      Our company also develops multipurpose applications for iOS
                      and MacOS systems and devices.
                    </p>
                    <a
                      className="button button-sm button-default button-ujarak"
                      href="hosting.html"
              ...
              <div className="col-md-6 col-lg-4">
                ...
                <article className="box-chloe box-chloe_secondary">
                  ...
                  <div className="box-chloe__main">
                    ...
                    <p>
                      We pay a lot of attention to QA and Testing procedures to
                      ensure the best quality of our software.
                    </p>
                    <a
                      className="button button-sm button-default button-ujarak"
                      href="hosting.html"
              ...
              <div className="col-md-6 col-lg-4">
                ...
                <article className="box-chloe box-chloe_secondary">
                  ...
                  <div className="box-chloe__main">
                    ...
                    <p>
                      Our Android apps are highly rated by media and our users as
                      they offer great features on all Android devices.
                    </p>
                    <a
                      className="button button-sm button-default button-ujarak"
                      href="hosting.html"
